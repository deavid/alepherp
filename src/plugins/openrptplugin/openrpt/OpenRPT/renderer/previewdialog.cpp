...
{
	setWindowTitle(trUtf8("Previsualización"));

    // widgets
    _view = new PreviewWidget(document, pPrinter, this);

    QToolButton *zoominbutton = new QToolButton(this);
	zoominbutton->setText(trUtf8("Acercar"));
	zoominbutton->setToolTip(trUtf8("Acerca la imágen"));
	QIcon icon1, icon2, icon3, icon4;
	icon1.addFile(QString::fromUtf8(":/preview/viewzoomin.png"), QSize(), QIcon::Normal, QIcon::Off);
	zoominbutton->setIcon(icon1);
	zoominbutton->setIconSize(QSize(16, 16));

    QToolButton *zoomoutbutton = new QToolButton(this);
	zoomoutbutton->setText(tr("Alejar"));
	zoomoutbutton->setToolTip(tr("Aleja la imágen"));
	icon2.addFile(QString::fromUtf8(":/preview/viewzoomout.png"), QSize(), QIcon::Normal, QIcon::Off);
	zoomoutbutton->setIcon(icon2);
	zoomoutbutton->setIconSize(QSize(16, 16));

    QDialogButtonBox *buttonbox = new QDialogButtonBox(this);
    buttonbox->setOrientation(Qt::Horizontal);
	QPushButton *printbutton = buttonbox->addButton(trUtf8("Imprimir"), QDialogButtonBox::AcceptRole);
	icon3.addFile(QString::fromUtf8(":/preview/printer_32.png"), QSize(), QIcon::Normal, QIcon::Off);
	printbutton->setIcon(icon3);
	printbutton->setIconSize(QSize(16, 16));
	QPushButton *cancelbutton = buttonbox->addButton(trUtf8("Cancelar"), QDialogButtonBox::RejectRole);
	icon4.addFile(QString::fromUtf8(":/preview/close.png"), QSize(), QIcon::Normal, QIcon::Off);
